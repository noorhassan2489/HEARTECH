...
class _NotificationPrefsState extends ConsumerState<NotificationPrefsScreen> {
  ...
  static const Map<String, _PrefGroup> _groups = {
    ...
    'Parent Notifications': _PrefGroup(
      items: [
    ...
    'Teacher Notifications': _PrefGroup(
      items: [
                            ...
                            child: Column(
                              children: group.value.items.map((item) {
                                ...
                                return SwitchListTile(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Always On',
                                                style:
                                                    HearTechTextStyles.caption(
                                                      color: HearTechColors
                                                          .coralRed,
                                                    ).copyWith(
                                                      fontWeight:
                                                          FontWeight.w700,
                                  ...
                                  activeTrackColor: HearTechColors.deepTeal
